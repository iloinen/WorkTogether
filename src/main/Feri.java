...
public class Feri {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000; i++) {
            int random2 = (int) (Math.random() * (max - min+1) + min);    // érték tartományt adsz meg
        ...
        System.out.println("volt köztük 1? " + (was1 ? "Igen" : "Nem"));
        System.out.println("volt köztük 6? " + (was6 ? "Igen" : "Nem"));
        ...
        for (int i = 0; i < randomCounter.length; i++) {
            System.out.println(i+1 + ": " + randomCounter[i] + " db");
        }
