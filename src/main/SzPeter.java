...
/* TODO
        ...
        for (int i = 0; i < 100; i++) {
            int random3 = (int) (Math.random() * (6 - 1) + 1);    // érték tartományt adsz meg

            if (random3 < 1 || random3 > 6) {
                System.out.println("rossz szám! " + random3);
            }
        }
        ...
        for (int i = 0; i < 100; i++) {
            // ide írd a kódod
            int random4 = (int) (Math.random() * (6 - 1) + 1);    // érték tartományt adsz meg
            randomCounter[random4 - 1] += 1;
        }
        System.out.println("A számok: " + Arrays.toString(randomCounter));
